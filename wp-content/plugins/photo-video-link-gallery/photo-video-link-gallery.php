...
class PGP {
	...
	public function PhotoGalleryPluginPro() {
	  $labels = array(
		'name' => __('轮播组管理','PGP_TEXT_DOMAIN' ),
		'singular_name' => __('轮播组管理','PGP_TEXT_DOMAIN' ),
		'add_new' => __('新增轮播组', 'PGP_TEXT_DOMAIN' ),
		'add_new_item' => __('新增轮播项目', 'PGP_TEXT_DOMAIN' ),
		'edit_item' => __('编辑轮播组', 'PGP_TEXT_DOMAIN' ),
		'new_item' => __('新增项目', 'PGP_TEXT_DOMAIN' ),
		'view_item' => __('预览', 'PGP_TEXT_DOMAIN' ),
		'search_items' => __('搜索项目', 'PGP_TEXT_DOMAIN' ),
		'not_found' => __('No Gallery found', 'PGP_TEXT_DOMAIN' ),
		'not_found_in_trash' => __('没有在回收站中发现', 'PGP_TEXT_DOMAIN' ),
		'parent_item_colon' => __('父轮播项目:', 'PGP_TEXT_DOMAIN' ),
		'all_items' => __('全部项目', 'PGP_TEXT_DOMAIN' ),
		'menu_name' => __('轮播组管理', 'PGP_TEXT_DOMAIN' ),
	  );
